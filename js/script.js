...
$(function(){
    ...
    $(".slide2 #slick-slide-control10").text("Hansoo Park");
    $(".slide2 #slick-slide-control11").text("Seungmin Kim");
    $(".slide2 #slick-slide-control12").text("Yongseon Moon");
    $(".slide2 #slick-slide-control13").text("Seungmin Choi");
    $(".slide2 #slick-slide-control14").text("Hyunseong Kim");
});
